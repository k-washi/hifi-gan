# Copy from https://github.com/ncsoft/avocodo/blob/main/avocodo/models/CoMBD.py
...
from src.avocodo.config import ComBDConfig
...
class CoMBD(torch.nn.Module):
    def __init__(self, h: ComBDConfig, pqmf_list, use_spectral_norm=False):
